...
// $triggerScript = "
// CREATE OR REPLACE TRIGGER VerifJoursOuvrablesChercheur
// BEFORE INSERT OR UPDATE ON CHERCHEUR1
// FOR EACH ROW
// DECLARE
...
//         RAISE_APPLICATION_ERROR(-20002, 'Les mises à jour ne sont autorisées que les jours ouvrables entre 8h et 18h.');
//     END IF;
// END;
...
// ";
$triggerScript="DROP TRIGGER VerifJoursOuvrablesChercheur";
// Préparer la requête
