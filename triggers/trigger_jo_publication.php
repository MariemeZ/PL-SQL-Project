...
// $triggerScript = "
// CREATE OR REPLACE TRIGGER VerifJoursOuvrablesPUBLICATION
// BEFORE INSERT OR UPDATE ON PUBLICATION1
// FOR EACH ROW
// DECLARE
...
//     IF jour_semaine IN ('Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi') AND heure_actuelle BETWEEN 8 AND 18 THEN
...
// ";
$triggerScript="DROP TRIGGER VerifJoursOuvrablesPUBLICATION";
// Préparer la requête
