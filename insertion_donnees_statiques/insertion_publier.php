...
$query_insert_publier = "
INSERT INTO PUBLIER1 (Chno, Pubno, Rang)
SELECT 1, 'Pub1', 1 FROM dual
UNION ALL
SELECT 2, 'Pub2', 2 FROM dual
UNION ALL
SELECT 3, 'Pub3', 3 FROM dual
";

$stid = oci_parse($conn, $query_insert_publier);
