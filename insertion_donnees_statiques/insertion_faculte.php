...
$query_insert_faculte = "
    INSERT INTO FACULTE1 (Facno, Facnom, Adresse, Libelle)
    SELECT 1, 'FST', 'Adresse1', 'Libelle1' FROM dual
    UNION ALL
    SELECT 2, 'Faculte2', 'Adresse2', 'Libelle2' FROM dual
";

$stid = oci_parse($conn, $query_insert_faculte);
