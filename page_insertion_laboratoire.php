  ...
  <body>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="page_index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Insertion d'un laboratoire <i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-3 bread">Insertion d'un laboratoire</h1>
          </div>
        </div>
      </div>
    </section>
	...
	<div class="col-md-8 block-9 mb-md-5">
			...
			<div class="form-group">
                <input type="text" class="form-control" placeholder="Numero" name="labno">
              </div>
			  <div class="form-group">
                <input type="text" class="form-control" placeholder="Nom" name="labnom">
              </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $labnom = isset($_POST['labnom']) ? $_POST['labnom'] : '';
    $facno = isset($_POST['facno']) ? $_POST['facno'] : '';

    // Préparer la requête d'insertion
    $queryInsertLabo = "INSERT INTO LABORATOIRE1 (LABNO, LABNOM, FACNO) VALUES (:labno, :labnom, :faculte)";
     $stid = oci_parse($conn, $queryInsertLabo);
    ...
    oci_bind_by_name($stid, ':labnom', $labnom);
    oci_bind_by_name($stid, ':faculte', $facno);
